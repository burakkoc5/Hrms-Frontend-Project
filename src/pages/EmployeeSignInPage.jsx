...
export default function EmployeeSignInPage() {
    ...
    const userSignInFormik = useFormik({
        ...
        onSubmit: values => {
          ...
          employeeService.checkEmployee(values.mail,values.password).then((result)=>result===null?console.log("hatali"):handleSignIn({id : result.data.data.id, accountType : accountType}))
      ...
      >
        <Grid.Column style={{ maxWidth: 450 }}>
          <Header as="h2" color="black" textAlign="center">
            <Image src="https://www.digitalhrms.com/images/logo.svg" size="massive" /> Log-in to your employee account
          </Header>
